        ...
        <div class="login-container">
            ...
            <form action="/NurseProject/index.php?controller=nurse&action=login" method="POST">
                ...
                <div class="form-actions">
                    ...
                    <p class="nurseRegister-link">Not registered yet? <a href="/NurseProject/Views/NurseRegistration/nurseRegistration.php">Register here</a></p>
                    <p class="patient-login">Patient? <a href="/NurseProject/Views/PatientLogin/patientLogin.php">Login</a></p>
                </div>
            </form>
