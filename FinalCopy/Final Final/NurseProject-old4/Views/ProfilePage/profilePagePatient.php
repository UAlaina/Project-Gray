...
<body>
    <div class="profile-container">
        <div class="header">
            <span class="back-btn" onclick="window.location.href='index.php?controller=patient&action=mainpage'">←</span>
        ...
        <div class="actions">
            ...
            <div class="action-row">
                ...
                <button class="btn btn-secondary" onclick="location.href='index.php?controller=feedback&action=form&nurseId=<?php echo $nurseId; ?>'"
                    >Feedback</button>
                </div>
            </div>
        </div>
