...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $projectRoot; ?>Views/styles/nurseRegistration.css">
</head>
<body>
    <div class="form-container">
        <h2>Create an Account</h2>
        <form method="POST" action="<?php echo $projectRoot; ?>index.php?controller=nurseRegistration&action=registerNurse">
            ...
            <div class="payment-section">
                ...
                <div class="form-section">
                    ...
                    <div class="form-actions">
                        ...
                        <p class="nurse-login">Already have an account? <a href="<?php echo $projectRoot; ?>Views/NurseLogin/nurselogin.php">Login</a></p>
                    </div>
                </div>
            </div>
        </form>
